...
| `docs-version-injection` | Compare generated version to source release metadata. | Covered by `scripts/build_site.py` and `scripts/validate_site.py`: `_site/assets/build.json` is generated from component source metadata and must not hard-code operator, runtime, Helm, Linux, or Windows versions. |
